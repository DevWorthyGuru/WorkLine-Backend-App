...
export class ChatMessagePage {
    ...
    async getAllEmployers() {
        ...
        const self = this;
        this.userService.getAllEmployers().then(async function (o) {
    ...
    showChatMessageEmployee(user: any) {
        this._router.navigate(['main/chat-message-employee', { empID: user.id, empName: user.name, empAvatar: user.avatar }]);
    }
